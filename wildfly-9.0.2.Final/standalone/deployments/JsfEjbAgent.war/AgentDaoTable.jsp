    ...
    <html>
        ...
        <body>
            <h:form>
                ...
                <h:dataTable value="#{agentBean.showAgentEjb()}" var="agent" border="3">
                    <h:column>
                        <f:facet name="header">
                    ...
                    <h:column>
                        ...
                        <h:commandButton action="#{agentBean.searchAgentEjb(agent.agentId)}" value="Search" />
                    </h:column>
                    ...
                    <h:column>
                        ...
                        <h:commandButton action="#{agentBean.deleteAgentEjb(agent.agentId)}" value="Delete" />
                    </h:column>
                </h:dataTable>
