...
//		System.out.println(this.venId);
	...
	public String addCustomerDao(Customer customer) {
		...
		trans.commit();
		String body ="Welcome to Restaurant Mr/Miss  " +customer.getCusname() + "\r\n"+
	...
	public String customerLoginDao(Customer customer) {
	    ...
	    // Use Criteria to fetch the user by their username
	    ...
	    if (customerFound != null) {
	        ...
	        if (encPass.equals(customerFound.getCuspassword())) {
